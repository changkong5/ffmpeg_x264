...
static void *frame_420p_argb_thread(void *arg)
{
	...
	o_fd = open("yuv420p_w640xh480.rgb", O_RDWR | O_CREAT, 0666);
...
static void *emulcap_thread(void *arg)
{
	...
	fd = open("yuv420p_w640xh480.yuv", O_RDWR | O_CREAT, 0666);
...
int main111(int argc, char *argv[]) {
	...
	out_file = fopen("yuv420p_w640xh480.h264", "wb+");
...
*/
	...
	while (1) {
        ...
        printf("%s: >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> <2>ts = %d, packet_len = %d\n", __func__, ts, packet_len);
