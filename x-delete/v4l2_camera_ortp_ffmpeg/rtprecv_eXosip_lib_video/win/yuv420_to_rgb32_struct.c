...
/*
            pix_format->yi_1 = ydata[(rows + 0) * min_w + cols + 0];
            pix_format->yi_2 = ydata[(rows + 0) * min_w + cols + 1];


            pix_format->yw_1 = ydata[(rows + 1) * min_w + cols + 0];
            pix_format->yw_2 = ydata[(rows + 1) * min_w + cols + 1];
