...
/////////////////////////////////////////////////////////////////
ssize_t mgmt_send_cmd_status(struct mgmt *mgmt,
				uint16_t index, uint16_t cmd, uint8_t status);
ssize_t mgmt_send_cmd_complete(struct mgmt *mgmt, uint16_t index, 
				uint16_t cmd, uint8_t status, uint16_t len, uint8_t *buf);
