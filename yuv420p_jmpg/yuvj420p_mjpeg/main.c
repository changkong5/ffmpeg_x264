...
int main(int argc, char *argv[])
{
	...
	fd = open("yuv420p_w1382xh928.jpg", O_RDWR | O_CREAT, 0666);
	
	// fd = open("yuv420p_w352xh288.png", O_RDWR | O_CREAT, 0666);
	
	i_fd = open("yuvj420p_w1382xh928.yuv", O_RDWR, 0666);
	...
	codec_ctx->width = 1382;
    codec_ctx->height = 928;
